...
export const systemMessage = "You are a helpful chef assistant that helps with creating recipes from incomplete lists of ingredients." +
            ...
            messages: [
                ...
                },
                {
                    ...
                    "content": [
                        {
                            "type": "text",
                            "text": `${input}. Generate a list of missing ingredients and a step-by-step recipe.`
                        }
                    ]
                }
            ]
